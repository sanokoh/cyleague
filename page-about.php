...
<main id="about_page">
	...
	<section id="about_company">
		<div class="about-company container">
			<div class="about-content">
				...
				<div class="text-block">
					...
					<p class="subheading pc-only">
						CyLeague
						Holdings（サイリーグホールディングス）は、日本の企業や組織のサイバーセキュリティを高めることを使命とする持株会社です。M&A、業務提携、自社サービスの開発を通じて、ITインフラやネットワークの安全性を確保しつつ、事業の成長と発展を支えます。
					</p>
				</div>
				<div class="detail">
					<div class="about-image">
						<picture>
							<source
								srcset="<?php echo get_stylesheet_directory_uri() . '/assets/images/building-image.avif'; ?>"
								type="image/webp">
							<img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/building-image.png'; ?>"
								alt="オフィスビルの外観" class="image">
						</picture>
					</div>
					<p class="description">
						<span class="sp-only"> CyLeague
							Holdings（サイリーグホールディングス）は、日本の企業や組織のサイバーセキュリティを高めることを使命とする持株会社です。M&A、業務提携、自社サービスの開発を通じて、ITインフラやネットワークの安全性を確保しつつ、事業の成長と発展を支えます。
						</span>
						「リーグ（League）」の精神のもと、グループ企業やパートナーと共に競い合い、日本のサイバーセキュリティ業界全体を牽引。セキュリティ人材の育成にも力を入れ、企業や組織が直面する脅威に迅速で効果的な対応ができる体制を整備します。
						国内のセキュリティ強化を基盤とし、アジアや国際市場にも進出し、デジタル時代における安心と安全を提供する総合的なサイバーセキュリティ企業を目指します。
					</p>
				</div>
			</div>
			<?php
			// リンク情報を配列で定義（スラッグのみ）
			$links = [
				['slug' => 'message', 'class' => 'message', 'text' => 'メッセージ'],
				['slug' => 'company', 'class' => 'company', 'text' => '会社概要/アクセス']
			];

			// URLを生成してテンプレートにリンク情報を渡す
	...
	<section id="group_companies">
		<disv class="group-companies container">
			<div class="group-companies__content">
				...
				<div class="company-overview">
					...
					<div class="image-container pr70 pl70">
						<picture>
							<source
								srcset="<?php echo get_stylesheet_directory_uri() . '/assets/images/change_holdings_logo_colored.avif'; ?>"
								type="image/webp">
							<img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/change_holdings_logo_colored.png'; ?>"
					...
					<div class="image-container container">
						<picture>
							<source
								srcset="<?php echo get_stylesheet_directory_uri() . '/assets/images/group_companies_NEW-IT.avif'; ?>"
								type="image/webp">
							<img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/group_companies_NEW-IT.png'; ?>"
								alt="NEW-ITのグループ企業: CHANGE、サイリーグホールディングス、E-Guardian、IdealRoute Consulting、DFA Robotics、beacapp、KaWaL eLearning、KaWaL診断"
								class="image">
						</picture>
						<picture>
							<source
								srcset="<?php echo get_stylesheet_directory_uri() . '/assets/images/group_comapnies_publitec.avif'; ?>"
								type="image/webp">
							<img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/group_comapnies_publitec.png'; ?>"
		...
		<div class="company-structure container">
			<div class="company-structure__content">
				...
				<div class="image-container">
					<picture>
						<source
							srcset="<?php echo get_stylesheet_directory_uri() . '/assets/images/company-structure.webp'; ?>"
							type="image/webp">
						<img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/company-structure.png'; ?>"
